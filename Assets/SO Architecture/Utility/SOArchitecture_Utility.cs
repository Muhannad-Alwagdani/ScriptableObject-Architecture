namespace ScriptableObjectArchitecture
{
    public static class SOArchitecture_Utility
    {
        ...
        public const string SOA_SUBMENU = "SOA/";
        public const string VARIABLE_SUBMENU = SOA_SUBMENU + "Variables/";
        public const string COLLECTION_SUBMENU = SOA_SUBMENU + "Collections/";
        public const string GAME_EVENT = SOA_SUBMENU + "Game Events/";
